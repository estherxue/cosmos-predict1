...
$E --tokenizers DV4x8x8-360p DV8x16x16-720p --tag jit_tokenize1_dv && echo STEP_JIT_DV_DONE
$E --tokenizers CV8x8x8-720p --mode fakequant --keep_bf16 conv_in patcher down.0 --tag int8_encmix_decfull_t1 && echo STEP_FQ_T1_DONE
